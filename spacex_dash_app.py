...
def get_pie_chart(site):
    ...
    if site == 'ALL':
        ...
        fig = px.pie(df, values='class count', names='class', title=f'Total Success Launches for site {site}')
    return fig
